...
interface MagicCardBaseProps {
  ...
  gradientFrom?: string
  gradientTo?: string
  /** Inner card background (defaults to the theme background token). */
  innerBackground?: string
  /** Border base color the radial gradient fades into. */
  borderColor?: string
}
...
/** Mirror the site's `html.dark` class so blend modes pick the right mode. */
function useIsDark() {
    ...
    <motion.div
      ...
      style={{
        background: useMotionTemplate`
          linear-gradient(${innerBackground} 0 0) padding-box,
